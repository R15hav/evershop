...
export default function HeadTags({
  ...
  return (
    <>
      <title>Wheee</title>
      <meta name="description" content= "Car Accessories Shop" />
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <meta property='og:title' content='Wheee.in'/>
      <meta property='og:image' content='/logo.png'/>
      <meta property='og:description' content="Car Accessories Shop"/>
      <meta property='og:url' content='https://wheee.in'/>
